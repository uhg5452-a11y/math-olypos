              ...
              <div className="mt-auto pt-2 flex items-center gap-2">
                ...
                {tourney.matches && tourney.matches.length > 0 && (
                  <button
                    ...
                    className="px-2.5 py-2 rounded-xl bg-rose-500/20 hover:bg-rose-500/30 border border-rose-500/40 text-rose-300 text-xs font-bold transition-all flex items-center gap-1"
                    title="เข้าชมการแข่งขันสด (Live Spectator Mode)"
                  >
                    <Eye className="w-3.5 h-3.5 text-rose-400 animate-pulse" /> ชมสด
                  </button>
                )}
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                          m.status === 'finished' ? 'bg-emerald-500/20 text-emerald-400' : 'bg-rose-500/20 text-rose-400 animate-pulse'
                        }`}>
                          {m.status === 'finished' ? 'จบแล้ว' : '🔴 กำลังแข่งสด'}
                        </span>
                        <button
                          type="button"
                          onClick={() => {
                          ...
                          className="px-2.5 py-1 rounded-lg bg-[#008DDA]/20 hover:bg-[#008DDA]/30 border border-[#008DDA]/40 text-[#008DDA] text-[11px] font-bold flex items-center gap-1 transition-all"
                        >
